...
if( "$in{submitter_email}" eq "" )  {
        $in{submitter_email} = "afilger\@filger.com";
}
if( "$in{submitter_name}" eq "" )  {
        $in{submitter_name} = "filger";
}
...
print SM "Organization Name: ",$in{"org_name"},"\n";
...
print SM "Country..........: ",$in{"org_country"},"\n";
